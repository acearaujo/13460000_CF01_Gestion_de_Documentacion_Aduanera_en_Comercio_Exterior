...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg_waves.bg_02.bg_top
      .row
        .col-12.col-lg-10.mx-auto
          ...
          p.mb-5 Los procedimientos arancelarios son el conjunto de pasos técnicos y legales que se deben seguir para el correcto manejo de mercancías en el comercio exterior. A continuación, se mencionan los tipos de procedimientos existentes.
    ...
    .row
      .col-12.col-lg-10.mx-auto
        .titulo-segundo.color-acento-contenido
          h2#t_4_3 4.3 Tipos de reglamentación

    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")     
      .col-md-2.col-lg-2.col-xl-2.col-6.mb-3.d-lg-block.d-none
        figure
    ...
    .row.mx-auto.justify-content-center
      ...
      .col-6.col-lg-3.d-none.d-lg-block
        figure.mb-5
